...
import { edgeDetectionCannyJS } from "../lib/edgeDetectionCanny";

const EdgeDetectionCannyPages = () => {
    ...
    const processJS = () => {
        ...
        const result = edgeDetectionCannyJS(original, width, height, buffer);
    ...
    return (
        <Layout
            title="Edge Detection Canny: JS vs WASM"
            subtitle="Compare edge detection in JavaScript and WebAssembly (Rust)"
...
export default EdgeDetectionCannyPages;
