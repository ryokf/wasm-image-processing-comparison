    ...
    return (
        <div className='flex flex-col items-center justify-center h-screen w-screen bg-gray-800'>
            ...
            <div className='mt-8 text-gray-300'>
                ...
                <Link to="/edge-detection-sobel" className='bg-green-500 !text-white px-4 py-2 rounded-md hover:bg-green-600 ml-4'>Sobel Edge Detection</Link>
                <Link to="/edge-detection-canny" className='bg-red-500 !text-white px-4 py-2 rounded-md hover:bg-red-600 ml-4'>Canny Edge Detection</Link>
            </div>
